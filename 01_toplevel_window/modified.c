/* example from xlibbook-0.5.pdf d
 * modified with regard to the exercises (2.2.3) */
...
/* combine seperate RGB values into one unsigned long */
#define RGB(r, g, b) \
...
int main(int argc, char *argv[])
{
	...
	at.background_pixel = RGB(0xFF, 0xFF, 0x00); // make background color yellow
	...
	do
	{
		...
		{
			case ButtonPress:
				//done = 1;    // makes the loop exit and hence quit the program
				printf("\a");  // prints a bell noise, i think...
				break;
			default:
				break;
		}
